...
@router.get("/keys/uuid",summary="Genera un UUID aleatorio con aleatoriedad cuántica")
def generate_uuid():
    """
...
@router.get("/keys/otp",summary="Genera una clave secreta para OTP con aleatoriedad cuántica.")
